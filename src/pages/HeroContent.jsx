        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2 space-y-8 text-center md:text-left animate-fade-in-right">
            ...
            <p className="text-gray-300 text-lg leading-relaxed font-light">
              Detail-oriented Full Stack Web Developer specializing in Frontend
              Engineering with a passion for crafting dynamic, user-friendly web
              experiences. Proficient in JavaScript, React, and Node.js. I bring
              a blend of development skills and QA expertise, enabling me to
              create dynamic, user-friendly, and scalable web applications. A
              dedicated problem-solver and resourceful{" "}
